...
senyawa_list = [
    ...
    ("Diklorometana", "CH2Cl2", "Iritasi dan karsinogenik", "Tinggi", "Tangani di tempat berventilasi", "Pelarut pembersih"),("Stiren", "C8H8", "Iritasi pernapasan, kemungkinan karsinogen", "Tinggi", "Gunakan ventilasi baik", "Monomer untuk plastik polistirena"),
    ("Asam benzoat", "C7H6O2", "Iritasi ringan", "Rendah", "Gunakan pelindung dasar", "Pengawet makanan, kosmetik"),
    ("Butanon (MEK)", "C4H8O", "Iritasi mata dan sistem saraf", "Sedang", "Hindari uap, gunakan APD", "Pelarut industri"),
    ("Akrilonitril", "C3H3N", "Karsinogenik, sangat toksik", "Tinggi", "Gunakan respirator dan APD lengkap", "Produksi plastik dan karet"),
    ("Asam format", "CH2O2", "Korosif, menyebabkan luka bakar", "Tinggi", "Gunakan pelindung mata dan sarung tangan", "Industri tekstil dan kulit"),
    ("Kresol", "C7H8O", "Korosif dan toksik", "Tinggi", "Tangani di lemari asam", "Disinfektan, resin"),
    ("Dimetilformamida", "C3H7NO", "Toksik hati, iritasi", "Tinggi", "APD lengkap & ventilasi", "Pelarut industri"),
    ("Karbon disulfida", "CS2", "Neurotoksik, sangat mudah terbakar", "Tinggi", "Lemari asam + respirator", "Produksi rayon"),
    ("1,4-Dioksana", "C4H8O2", "Kemungkinan karsinogen", "Tinggi", "Gunakan fume hood", "Pelarut organik"),
    ...
    ("Asam nitrat", "HNO3", "Oksidator kuat, korosif", "Tinggi", "Tangani di lemari asam", "Pembuatan pupuk & peledak"),
    ("Asam pikrat", "C6H2(NO2)3OH", "Peledak & racun", "Tinggi", "Tangani sangat hati-hati", "Reagen kimia"),
    ("Asam kloroasetat", "C2H3ClO2", "Toksik, luka bakar", "Tinggi", "APD lengkap", "Sintesis farmasi & herbisida"),
    ("Kloral hidrat", "C2H3Cl3O2", "Sedatif, toksik SSP", "Tinggi", "Ventilasi baik", "Obat penenang (dulu)"),
    ("Asam propionat", "C3H6O2", "Iritasi kulit/mata", "Sedang", "Pelindung kulit & mata", "Pengawet makanan"),
    ("Nitroetana", "C2H5NO2", "Mudah terbakar & toksik", "Tinggi", "Ventilasi baik", "Pelarut & bahan peledak"),
    ("Asam perasetat", "C2H4O3", "Oksidator kuat, korosif", "Tinggi", "APD lengkap", "Sterilisasi alat medis"),
    ("Asam laurat", "C12H24O2", "Iritasi ringan", "Rendah", "Gunakan APD ringan", "Kosmetik & sabun"),
    ("Asam stearat", "C18H36O2", "Tidak berbahaya umum", "Rendah", "Tangani normal", "Lilin & pelumas"),
    ("Asam oleat", "C18H34O2", "Iritasi ringan", "Rendah", "APD ringan", "Kosmetik & makanan"),
    ...
    ("Asam itakonat", "C5H6O4", "Iritasi ringan", "Rendah", "Pelindung dasar", "Polimer & bahan kimia industri"),
